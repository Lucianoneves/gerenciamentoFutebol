...
router.put("/pagamentos/:id", atualizarPagamento);    // Atualizar pagamento
...
router.put("/churrasco/despesa/:id", atualizarDespesa); // atualizar despesa
router.delete("/churrasco/despesa/:id", deletarDespesa); // deletar despesa
