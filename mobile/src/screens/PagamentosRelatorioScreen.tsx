...
const styles = StyleSheet.create({
  ...
  relatorio: { padding: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: "#1b1f1c", borderRadius: 8, marginBottom: 16, backgroundColor: "#0f3d14" },
  relatorioTitle: { fontSize: 16, fontWeight: "700", marginBottom: 8, color: "#FFFFFF" },
  mesSelector: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 8 },
  mesLabel: { fontWeight: "700", color: "#FFFFFF" },
  btnMes: { backgroundColor: "#2c2c2c", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  btnText: { color: "#FFFFFF", fontSize: 12, fontWeight: "700" },
  sectionTitle: { fontWeight: "700", color: "#FFFFFF" },
  emptyText: { color: "#FFFFFF" },
  itemLine: { color: "#FFFFFF" },
  alertText: { color: "#ff4d4f", fontWeight: "700" },
  successText: { color: "#1e7f3a", fontWeight: "700" },
  mesesChips: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 8 },
  chip: { borderWidth: StyleSheet.hairlineWidth, borderColor: "#1e7f3a", borderRadius: 16, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: "#2c2c2c" },
  chipActive: { backgroundColor: "#1e7f3a", borderColor: "#333b35" },
